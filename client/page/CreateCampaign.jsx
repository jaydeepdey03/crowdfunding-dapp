...
const CreateCampaign = () => {
    ...
    return (
        <>
            <div className="campaign-bg h-full flex-col flex place-item-center">
                <div onClick={() => router.back()} className={`w-[52px] h-[52px] rounded-full cursor-pointer ml-6 mt-6 plus-linear-gradient flex items-center justify-center`}>
                ...
                <div className="flex flex-col place-items-center h-full w-full p-10">
                    <form className="bg-white shadow-md rounded p-7 flex flex-col space-y-6 justify-center">
