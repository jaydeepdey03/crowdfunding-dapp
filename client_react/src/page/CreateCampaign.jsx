  ...
  return (
    <>
      <div className="campaign-bg flex-col flex place-item-center">
        <div
          onClick={() => navigate(-1)}
          className={`w-[52px] h-[52px] rounded-full cursor-pointer ml-6 mt-6 plus-linear-gradient flex items-center justify-center`}
        >
          <svg
        ...
        <div className="flex flex-col place-items-center h-full w-full p-10">
          <form
            ...
            className="bg-white shadow-md rounded p-7 flex flex-col space-y-6 justify-center"
          >
            ...
            <div className="sm:w-full flex justify-start items-center p-4 bg-[#8c6dfdbb] h-[120px] rounded-[10px] mt-5">
              ...
              />
              <h4 className="font-epilogue font-bold text-sm sm:text-[25px] text-white ml-[20px]">
